...
public class FixPrefabMaterials
{
    ...
    {
        string matPath = "Assets/5 - External Imports/Village & Buildings/MedievalMarketDemo/Materials/M_VertexPaint_All.mat";
        ...
        string[] prefabGuids = AssetDatabase.FindAssets("t:Prefab", new[] { "Assets/5 - External Imports/Village & Buildings/MedievalMarketDemo/Prefabs" });
        int fixedCount = 0;
        int prefabCount = 0;
