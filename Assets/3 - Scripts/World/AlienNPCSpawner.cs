...
public class AlienNPCSpawner : MonoBehaviour
{
    ...
    [Tooltip("Optional. When assigned, the spawner reads maxAlienNPCs from this asset every tick. Since 2026-09-08 that number is DERIVED from the VIEW DISTANCE slider rather than set directly, so density holds steady at any view distance.")]
